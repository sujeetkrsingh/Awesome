<?php
/*Subscrption Configuration*/
$_emailSalutation="Dear Visitor";
$_emailMessage="Thank you for subscription, we'll keep you updating whenever we have something new to share regarding launch of our website.";
